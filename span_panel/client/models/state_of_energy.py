...
class StateOfEnergy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StateOfEnergy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StateOfEnergy:
        """Create an instance of StateOfEnergy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StateOfEnergy.parse_obj(obj)

        _obj = StateOfEnergy.parse_obj({"percentage": obj.get("percentage")})
        return _obj
