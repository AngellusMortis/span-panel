...
class BooleanIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BooleanIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BooleanIn:
        """Create an instance of BooleanIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BooleanIn.parse_obj(obj)

        _obj = BooleanIn.parse_obj({"value": obj.get("value")})
        return _obj
