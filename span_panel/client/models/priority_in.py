...
class PriorityIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriorityIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriorityIn:
        """Create an instance of PriorityIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriorityIn.parse_obj(obj)

        _obj = PriorityIn.parse_obj({"priority": obj.get("priority")})
        return _obj
