...
class RelayStateIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelayStateIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelayStateIn:
        """Create an instance of RelayStateIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelayStateIn.parse_obj(obj)

        _obj = RelayStateIn.parse_obj({"relay_state": obj.get("relayState")})
        return _obj
