...
class MainMeterEnergy(BaseModel):
    """
    MainMeterEnergy
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MainMeterEnergy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MainMeterEnergy:
        """Create an instance of MainMeterEnergy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MainMeterEnergy.parse_obj(obj)

        _obj = MainMeterEnergy.parse_obj(
            {
